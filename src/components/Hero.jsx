    ...
    <>
      ...
      >
        ...
        <div className="max-w-full">
          <p data-aos="fade-right" className="text-3xl text-slate-300 font-semibold">
            {t("hero.des_name")}
          </p>
          <h2
            data-aos="fade-right"
            className="typing py-3 mt-4 text-4xl md:text-5xl font-bold text-orange-500"
          >
            &nbsp;&nbsp;{t("hero.name")}
          </h2>
          <p
            data-aos="fade-left"
            className="text-lg mt-4 text-gray-300 animate-pulse  font-semibold"
          >
            {t("hero.carrer")}
          </p>
          <a
          ...
          <div data-aos="zoom-in-up" className="mt-6 flex space-x-6 text-2xl">
            <a
              ...
              aria-label="Facebook"
              className="text-white hover:text-orange-600 dark:hover:text-blue-500  transition duration-300 hover:translate-y-[-2px]"
            >
              <FaFacebookF />
            </a>
            <a
