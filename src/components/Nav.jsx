...
const Nav = ({ theme, toggleTheme }) => {
  ...
  return (
    <>
      <nav
        className={` flex justify-between items-center px-8 py-4 fixed top-0 right-0 left-0 w-full z-50
            backdrop-blur-sm `}
      >
        ...
        {/* Desktop view */}
        {!isMobile && (
          <ul className={`flex space-x-5 text-lg ${isHero ? "text-white dark:text-white" : "text-slate-800"}`}>
            <li
